...
public class IntermediateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button[] buttons= new Button[]{binding.inter1,binding.inter2,binding.inter3,binding.inter4,
                binding.inter5,binding.inter6,binding.inter7,binding.inter8,binding.inter9,binding.inter10};
        ...
        buttons[0].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(matches == (buttons.length/2)){
                    IntermediateFragmentDirections.ActionIntermediateFragmentToResultsFragment action = IntermediateFragmentDirections.actionIntermediateFragmentToResultsFragment(turn);
